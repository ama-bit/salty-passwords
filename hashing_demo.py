...
def main():
    ...
    print(f"Salt: {salt1}")
    print(f"Hash: {hash1}")
    print(f"Pepper (for clarity, not visible in hash directly): {PEPPER}")
    print("\nNote: The pepper is a secret, server-side value that is added to the password and salt before hashing.")
